...
@Author: 拎把木剑当大侠
@Description: 
@Date: 2019-04-18 16:53:19
@LastEditTime: 2019-04-18 18:24:36
'''


class Solution(object):
    def geweishu(self, num):
        retval = ["One", "Two", "Three", "Four",
                  "Five", "Six", "Seven", "Eight", "Nine"]
        return retval[num-1]

    def shiweishu(self, num):
        retval = ["Twenty", "Thirty", "Forty", "Fifty",
                  "Sixty", "Seventy", "Eighty", "Ninety"]
        return retval[num-2]

    def tens(self, num):
        retval = ["Ten", "Eleven", "Twelve", "Thirteen", "Fourteen",
