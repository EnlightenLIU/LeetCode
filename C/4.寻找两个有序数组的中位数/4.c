 ...
 * @LastEditTime: 2019-01-10 14:57:01
 * @Description: 
 */
...
static double find_kth(int a[], int alen, int b[], int blen, int k)
{
    ...
    int ia = k / 2 < alen ? k / 2 : alen; //k/2>=alen时，ia=alen?
    int ib = k - ia;
    if (a[ia - 1] < b[ib - 1])
    {
